package PartitianArrayIntoThreePartsWithEqualSum;
import java.util.*;
...
class Solution {
	public boolean canThreePartsEqualSum(int[] arr) {
		...
		int currSum = 0;
		for (int i = 0; i < arr.length; i++) {
			if (numOfpartition == 2) return true;
			currSum += arr[i];
